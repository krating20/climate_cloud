...
directory = '2020drought_json'
directory_path = '2020drought_json'
csv_path ='cdf/apcp.2020.csv'
csv_out ='2020_final.csv'
...
def catchecker(lon,lat,filename):
    print(lon,lat)
    #if lat lon file name = -115.8204 32.54809 20200818.json
