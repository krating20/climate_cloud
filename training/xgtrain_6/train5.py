...
df_2010 = pd.read_csv('updated_tcdc_2010.csv')
df_2011 = pd.read_csv('updated_tcdc_2011.csv')
df_2012 = pd.read_csv('updated_tcdc_2012.csv')
df_2013 = pd.read_csv('updated_tcdc_2013.csv')
df_2014 = pd.read_csv('updated_tcdc_2014.csv')
df_2015 = pd.read_csv('updated_tcdc_2015.csv')
df_2016 = pd.read_csv('updated_tcdc_2016.csv')
df_2017 = pd.read_csv('updated_tcdc_2017.csv')
df_2018 = pd.read_csv('updated_tcdc_2018.csv')
df_2019 = pd.read_csv('updated_tcdc_2019.csv')
df_2022 = pd.read_csv('updated_tcdc_2022.csv')
...
X_train = df_train[['lat', 'lon', 'apcp','tcdc','bgrun','air']].values
y_train = df_train['drought_catagory'].values

# Extract features for testing data
X_test = df_2022[['lat', 'lon', 'apcp','tcdc','bgrun','air']].values
